...
@section('title', __('message.tambahsubkategori'))
                ...
                <div class="section-header-breadcrumb">
                    <ul class="nav nav-pills">
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item active"><a
                                    href="{{ route('data.group.index') }}">{{ __('message.subktgmotorik') }}</a>
                            </div>
            ...
            <div class="section-body">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="form" action="{{ route('subkategori.motorik.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end">
                                            <a class="btn btn-dark mr-1" href="{{ route('subkategori.motorik.index') }}">
