                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date"
                                                        ...
                                                        name="tglbuat" id="nm" value="{{ old('tglbuat') }}" required
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date"
                                                        ...
                                                        name="tglberlaku" id="tglberlaku" value="{{ old('tglberlaku') }}"
                                                        required
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"
                                                        class="form-control  @error('nm') is-invalid @enderror"
                                                        name="judul" id="judul" value="{{ old('judul') }}" required
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="summernote" name="pengumuman" id="pengumuman" required
                                                        data-parsley-required-message="{{ __('message.ctnrequired') }}" style="height: 100px">{!! old('pengumuman') !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
