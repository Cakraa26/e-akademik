...
@section('title', __('message.grpmotorik'))
                ...
                <div class="section-header-breadcrumb">
                    <ul class="nav nav-pills">
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">{{ __('message.grpmotorik') }}</div>
                        </div>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-5 mb-md-0">
                                <a class="btn btn-success {{ Request::is('data-group/create') ? 'active' : '' }}"
                                    href="{{ route('data.group.create') }}" data-toggle="tooltip"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($group as $g)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{ route('data.group.edit', $g->pk) }}"
                                                        class="btn btn-info {{ Request::is('data-group/' . $g->pk . '/edit') ? 'active' : '' }}"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>

                                                    <form action="{{ route('data.group.destroy', $g->pk) }}" method="POST"
