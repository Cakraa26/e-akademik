...
@section('title', __('message.editgroup'))
            ...
            <div class="section-body">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="form" action="{{ route('data.group.update', $group->pk) }}" method="POST"
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"
                                                        ...
                                                        name="nm" id="nm" value="{{ old('nm', $group->nm) }}" required
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="status" name="aktif" value="1" 
                                                            {{ old('aktif', $group->aktif) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12 d-flex justify-content-end">
                                            <a class="btn btn-dark load-btn mr-2" href="{{ route('data.group.index') }}">
