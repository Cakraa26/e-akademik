...
@section('title', __('message.tambahkategori'))
            ...
            <div class="section-body">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="form" action="{{ route('kategori.psikomotorik.store') }}" method="POST"
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12 d-flex justify-content-end">
                                            <a class="btn btn-dark load-btn mr-2" href="{{ route('kategori.psikomotorik.index') }}">
